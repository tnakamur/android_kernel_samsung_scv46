...
#elif IS_ENABLED(CONFIG_EXYNOS_DECON_LCD_HX83102D_A10E_JPN)
struct dsim_lcd_driver *mipi_lcd_driver = &hx83102d_mipi_lcd_driver;
#elif IS_ENABLED(CONFIG_EXYNOS_DECON_LCD_HX83102P_GTA4S)
struct dsim_lcd_driver *mipi_lcd_driver = &hx83102p_mipi_lcd_driver;
#else
